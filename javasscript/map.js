...
var Great = L.marker([40.33,116.48]).addTo(mymap);
...
var Taj = L.marker([27.17, 78.04]).addTo(mymap);
  ...
  var Brazil = L.marker([-22.95,-43.21]).addTo(mymap);
  var Macchu=L.marker([-13.16,-72.55]).addTo(mymap);
  // var marker = L.marker([40.33, 116.48]).addTo(mymap);
  //     marker.on('click', function(e){
  //     mymap.setView(e.latlng, 14);
  //     })
